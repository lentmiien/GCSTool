    ...
    data.forEach(order => {
      if (order.length > 0) {
        ...
        if (cols.length === 3) {
          ...
          tbody += `<tr><td>${sub_cols[0]}</td><td>${sub_cols[1]}</td><td class="${b.indexOf('1') >= 0 ? "table-danger" : "bg-success"}" title="EMS">${b.indexOf('1') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('2') >= 0 ? "table-danger" : "bg-success"}" title="SAL Small Packet Registered">${b.indexOf('2') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('3') >= 0 ? "table-danger" : "bg-success"}" title="SAL Small Packet Unregistered">${b.indexOf('3') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('4') >= 0 ? "table-danger" : "bg-success"}" title="Domestic">${b.indexOf('4') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('5') >= 0 ? "table-danger" : "bg-success"}" title="SAL Parcel">${b.indexOf('5') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('6') >= 0 ? "table-danger" : "bg-success"}" title="Air Parcel">${b.indexOf('6') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('11') >= 0 ? "table-danger" : "bg-success"}" title="Air Small Packet Unregistered">${b.indexOf('11') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('17') >= 0 ? "table-danger" : "bg-success"}" title="Air Small Packet Registered">${b.indexOf('17') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('19') >= 0 ? "table-danger" : "bg-success"}" title="DHL">${b.indexOf('19') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('20') >= 0 ? "table-danger" : "bg-success"}" title="AIT">${b.indexOf('20') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('21') >= 0 ? "table-danger" : "bg-success"}" title="Surface Parcel">${b.indexOf('21') >= 0 ? "" : "◎"}</td><td class="${b.indexOf('22') >= 0 ? "table-danger" : "bg-success"}" title="ECMS">${b.indexOf('22') >= 0 ? "" : "◎"}</td></tr>`;
        } else {
          // Current format
