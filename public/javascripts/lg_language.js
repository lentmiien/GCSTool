var json_language = {
  ...
  _welcome_gcs_tool_: {
    ...
    swedish:
      'Välkommen till GCS Assist Verktyg. Nedan kan du se dom senaste updateringar, och längst ner kan du ändra dina personliga inställningar.',
    japanese: 'GCS支援ツールへようこそ。最近の更新内容は下記に確認できる、そして一番下には個人設定ができる。',
  },
  _news_: {
    english: '** NEWS **',
    swedish: '** NYHETER **',
  ...
  _update_uid_: {
    english: 'Update User ID',
    swedish: 'Updatera Användar ID',
    japanese: 'ユーザーID更新',
  },
  _update_color_: {
    english: 'Update Color Mode',
    swedish: 'Updatera Färg läge',
    japanese: 'カラー設定更新',
  },
  _normal_: {
    english: 'Normal',
  ...
  _set_once_: {
    english: '*Can not be changed after set',
    swedish: '*Kan inte ändras efter sätt',
    japanese: '＊設定後は変更できない',
  },
  _update_on_next_: {
    english: '*Updates at the next page you open',
    swedish: '*Uppdateras på nästa sida du öppnar',
    japanese: '＊次のページロードに反映される',
  },
  _show_popup_: {
    english: '*Shows a popup message at the given time',
    swedish: '*Visar popup meddelande på angiven tid',
    japanese: '＊指定時間にポップアップメッセージを表示する',
  },
  _create_new_: {
    english: 'Create New',
    swedish: 'Skapa Ny',
  ...
  _top_settings_: {
    english: 'Top/Settings',
    swedish: 'Top/Inställningar',
    japanese: 'トップ・設定',
  },
  _content_: {
    english: 'Content',
  ...
  _add_staff_: {
    english: 'Add Staff',
    swedish: 'Lägg Till Personal',
    japanese: 'スタッフ追加',
  },
  _remove_staff_: {
    english: 'Remove Staff',
  ...
  _entry_added_: {
    english: 'Entry Added',
    swedish: 'Inlägg tillagt',
    japanese: 'エントリー追加',
  },
  _entry_deleted_: {
    english: 'Entry deleted',
    swedish: 'Inlägg borttaget',
    japanese: 'エントリー削除済み',
  },
  _entry_updated_: {
    english: 'Entry updated',
    swedish: 'Inlägg uppdaterat',
    japanese: 'エントリー更新済み',
  },
  _confirm_delete_: {
    english: 'Confirm Delete',
    swedish: 'Bekräfta Ta Bort',
    japanese: '削除確認',
  },
  _confirm_delete_1_: {
    english: 'Do you wish to delete "',
    swedish: 'Vill du ta bort "',
    japanese: '「',
  },
  _confirm_delete_2_: {
    english: '"?',
  ...
  _couldnt_delete_: {
    english: 'Could not delete',
    swedish: 'Kunde inte ta bort',
    japanese: '削除できなかった',
  },
  _couldnt_update_: {
    english: 'Could not update',
    swedish: 'Kunde inte uppdatera',
    japanese: '更新できなかった',
  },
  _back_: {
    english: 'Back',
  ...
  _ship_details_1_: {
    english: '*ASP and SAL Reg are combined, SAL Parcel and Air Parcel are combined, as separate data is unavailable.',
    swedish: '*ASP och SAL Reg är kombinerade, SAL Parcel och Air Parcel är kombinerade, eftersom separat data inte är tillgängligt.',
    japanese: '*区別できるデータが無い為に、ASPとSAL regは一緒、SAL ParcelとAir Parcelは一緒だ。',
  },
  _ship_details_2_: {
    english: '**SAL Unreg: no tracking data available.',
  ...
  _team_members_: {
    ...
    swedish: 'Lag Medlemmar',
    japanese: 'チームメンバー',
  },
  _show_schedule_: {
    english: 'Show Schedule',
    swedish: 'Visa Schema',
    japanese: 'スケジュール表示',
  },
  _jan_: {
  ...
  _tooltip_enter_data_: {
    english:
      "<h4>Template and Company Contact is text formated</h4>Any text you write will be formated exactly the same way when used.<h4>Manual is HTML formated</h4>*Some common HTML tags<br><b>&lt;br&gt;</b><span>: New Line</span><br><b>&lt;b&gt;Bold Text&lt;/b&gt;</b><br><b>&lt;i&gt;Italic Text&lt;/i&gt;</b><br><b>&lt;u&gt;Underline Text&lt;/u&gt;</b><br><b>&lt;h1&gt;Large Title&lt;/h1&gt;</b><br>(Large) h1 - h2 - h3 - h4 - h5 (Small)<br><b>&lt;h5&gt;Small Title&lt;/h5&gt;</b><br><b>&lt;ol&gt;&lt;li&gt;Number List#1&lt;/li&gt;&lt;li&gt;Number List#2&lt;/li&gt;&lt;/ol&gt;</b><br><b>&lt;ul&gt;&lt;li&gt;Dot List&lt;/li&gt;&lt;li&gt;Dot List&lt;/li&gt;&lt;/ul&gt;</b><br>Link Button (Filter word, Tag, is_Template, is_Manual, is_CompanyContact)<br><b>&lt;button onclick=\"SetFilter('cancel', '_', 'true', 'true', 'true')\"&gt;Button Text&lt;/button&gt;</b><br>Update coloring <span style=\"background-color:#338833;\">1 week</span> <span style=\"background-color:#888833;\">1 month</span> <span style=\"background-color:#333388;\">3 months</span><br><b>&lt;... data-update=\"2022-11-22\"&gt;Text with update coloring&lt;/...&gt;</b>(*... replaced by valid HTML tag)<hr><b>&lt;div class=\"lennart\"&gt;message from Lennart&lt;/div&gt;</b><span>: Colored text box, change name for other colors</span>",
    swedish:
      "<h4>Mallar och Företags Kontakt är text formaterade</h4>All text kommer att sparas och visas exact som du skriver in texten.<h4>Manualer är HTML formaterade</h4>*Några vanliga HTML taggar<br><b>&lt;br&gt;</b><span>: Ny Rad</span><br><b>&lt;b&gt;Fet Text&lt;/b&gt;</b><br><b>&lt;i&gt;Cursive Text&lt;/i&gt;</b><br><b>&lt;u&gt;Understruken Text&lt;/u&gt;</b><br><b>&lt;h1&gt;Stor Title&lt;/h1&gt;</b><br>(Stor) h1 - h2 - h3 - h4 - h5 (Liten)<br><b>&lt;h5&gt;Liten Title&lt;/h5&gt;</b><br><b>&lt;ol&gt;&lt;li&gt;Numrerad Lista#1&lt;/li&gt;&lt;li&gt;Numrerad Lista#2&lt;/li&gt;&lt;/ol&gt;</b><br><b>&lt;ul&gt;&lt;li&gt;Punkt Lista&lt;/li&gt;&lt;li&gt;Punkt Lista&lt;/li&gt;&lt;/ul&gt;</b><br>Länk Knapp (Filter ord, Tagg, är_Mall, är_Manual, är_FöretagsKontakt)<br><b>&lt;button onclick=\"SetFilter('cancel', '_', 'true', 'true', 'true')\"&gt;Knapp Text&lt;/button&gt;</b><br>Updaterad färgning <span style=\"background-color:#338833;\">1 vecka</span> <span style=\"background-color:#888833;\">1 månad</span> <span style=\"background-color:#333388;\">3 månader</span><br><b>&lt;... data-update=\"2022-11-22\"&gt;Text med udaterad färgning&lt;/...&gt;</b>(*... utbytt mot giltig HTML tag)<hr><b>&lt;div class=\"lennart\"&gt;meddelande från Lennart&lt;/div&gt;</b><span>: Färgad text ruta, ändra namn för andra användare</span>",
    japanese:
      "<h4>テンプレート・会社連絡はテキストフォーマット</h4>入力したままに保存したり、表示したりする。<h4>マニュアルはHTMLフォーマット</h4>＊一部の一般的なHTMLタグ<br><b>&lt;br&gt;</b><span>：　改行</span><br><b>&lt;b&gt;ボルド&lt;/b&gt;</b><br><b>&lt;i&gt;イタリック&lt;/i&gt;</b><br><b>&lt;u&gt;下線&lt;/u&gt;</b><br><b>&lt;h1&gt;タイトル（大）&lt;/h1&gt;</b><br>（大） h1 - h2 - h3 - h4 - h5 （小）<br><b>&lt;h5&gt;タイトル（小）&lt;/h5&gt;</b><br><b>&lt;ol&gt;&lt;li&gt;番号リスト#1&lt;/li&gt;&lt;li&gt;番号リスト#2&lt;/li&gt;&lt;/ol&gt;</b><br><b>&lt;ul&gt;&lt;li&gt;ドットリスト&lt;/li&gt;&lt;li&gt;ドットリスト&lt;/li&gt;&lt;/ul&gt;</b><br>リンクボタン (フィルター言葉, タグ, テンプレートです, マニュアルです, 会社連絡です)<br><b>&lt;button onclick=\"SetFilter('cancel', '_', 'true', 'true', 'true')\"&gt;ボタンテキスト&lt;/button&gt;</b><br>更新色付け<span style=\"background-color:#338833;\">1週間</span><span style=\"background-color:#888833;\">1ヶ月</span><span style=\"background-color:#333388;\">3ヶ月</span><br><b>&lt;... data-update=\"2022-11-22\"&gt;更新色付きテキスト&lt;/...&gt;</b>(*...は有効なHTMLタグに差し替え)<hr><b>&lt;div class=\"lennart\"&gt;レンナルトからのメッセージ&lt;/div&gt;</b><span>：色付きのテキスト枠、名前を変更したら、色も変わる</span>",
  },
  _tracker_: {
    english: 'Tracker',
    swedish: 'Spåra',
