var json_language = {
  ...
  _welcome_gcs_tool_: {
    ...
    japanese:
      "GCS支援ツールへようこそ。最近の更新内容は下記に確認できる、そして一番下には個人設定ができる。"
  },
  _news_: {
    english: "** NEWS **",
    swedish: "** NYHETER **",
  ...
  _news_update_: {
    english:
      "*Updated within last month (NEW = Created within last 7 days, UPDATED = Updated within last 7 days)",
    swedish:
      "*Updaterad inom senaste månaden (NEW = Skapade de senaste 7 dagarna, UPDATED = Updaterad de senaste 7 dagarna)",
    japanese:
      "＊最近の1ヶ月以内更新された（NEW＝1週間以内新規作成された、UPDATED＝1週間以内更新された）"
  },
  _template_: {
    english: "Template",
    swedish: "Mall",
