...
function ShowReminders() {
  ...
  reminder_html +=
    '<tr><td><div class="d-flex justify-content-evenly"><div><input id="sunday_reminder" type="checkbox" title="Sunday" checked></div><div><input id="monday_reminder" type="checkbox" title="Monday" checked></div><div><input id="tuesday_reminder" type="checkbox" title="Tuesday" checked></div><div><input id="wednesday_reminder" type="checkbox" title="Wednesday" checked></div><div><input id="thursday_reminder" type="checkbox" title="Thursday" checked></div><div><input id="friday_reminder" type="checkbox" title="Friday" checked></div><div><input id="saturday_reminder" type="checkbox" title="Saturday" checked></div></div></td><td><input class="form-control mr-sm-2" id="reminder_time" type="text", placeholder="12:00"></td><td><input  class="form-control mr-sm-2" id="reminder_message" type="text" placeholder="Message"></td><td><button class="btn btn-outline-success" onclick="AddReminder()">' +
